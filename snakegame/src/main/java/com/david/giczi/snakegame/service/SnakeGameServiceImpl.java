...
public class SnakeGameServiceImpl implements SnakeGameService, ComponentColor {
	...
	@Override
	public List<Component> createEdibleComponentStore(List<Component> snake) {
	...
	@Override
	public List<Component> createBarrierComponentStore(List<Component> snake, List<Component> edibleComponentStore) {
